...
public class US_009_TC_004 extends TestBaseRapor {
    @Test
    public void deleteButonuAlert(){

        extentTest=extentReports.createTest("Concort Hotel Test","Delete tuşuna basıldığında alert mesajı görülebilmeli");
        ...
        extentTest.pass("Delete tusuna basilmali ve alert yazisi gorulmeli");
        //11-"DELETE" tusuna basilmali alert yazisi gorulmeli
